...
$empleado = mysqli_fetch_assoc($resultado2);
...
$usuario = $empleado['usuario_empleado'];
$dni = $empleado['dni_empleado'];
$activo = $empleado['activo_empleado'];
...
if($_SERVER['REQUEST_METHOD']  === 'POST'){
    ...
    if(empty($errores)){
        ...
        $query = "UPDATE empleados SET nombre_empleado = '$nombre',apellido_empleado = '$apellido' ,usuario_empleado = '$usuario',dni_empleado = '$dni',activo_empleado = '$activo',telefono_empleado = '$telefono',rol = '$rol' WHERE id_empleado = '$id'";
        $resultado = mysqli_query($con,$query);
        
        
        if($resultado){
            header('Location: panelempleados.php?resultado=2');
        }
    }   
}
?>
...
<nav class="barra">
    ...
    <form action="" method="POST" class="formulario">
        ...
        <h1 class="texto" >modificar un empleado</h1>
